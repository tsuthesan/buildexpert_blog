                    ...
                    <form action="{{ route('permissions.destroy',$permission->id) }}" method="POST">
                        ...
                        <div class="col-md-12 ">
                            <div class="bg-gradient-danger mb-8 mt-7">
                                <h5 class="card-title">Are you sure you want to delete all the details
                                    of {{ $permission->name }} ? </h5>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a href="{{ route('permissions.index') }}" class="btn btn-dark btn-md"><i
                                        class="mdi mdi-cancel"></i>Cancel</a>
                                <button type="submit" class="btn btn-danger btn-md float-right"><i
