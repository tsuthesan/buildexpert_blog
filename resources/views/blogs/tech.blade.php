        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="page-breadcumb pull-right">
                    <i class="fa fa-home"></i> <a href="{{ route('welcome') }}">Home</a> <i class="fa fa-angle-right"></i> </i> <span>Expert-eye</span> <i class="fa fa-angle-right"></i> <span>New Technology</span>
                </div> <!-- /.page-breadcumb -->
            </div>
        </div>
    </div>
